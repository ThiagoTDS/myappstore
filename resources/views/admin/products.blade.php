        ...
        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
            ...
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                <tr @if($loop->even)class="bg-gray-100"@endif>
                    ...
                    <td class="px-4 py-3">
                    <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{asset($product->cover)}}">
                    </td>
                    ...
                    <td class="px-4 py-3 text-sm text-right space-x-3 text-gray-900">
                        ...
                        <a href="{{route('admin.product.delete', $product->id)}}" class="mt-3 text-indigo-500 inline-flex items-center delete-link">Deletar</a>
                    </td>
                </tr>
                @endforeach
                </tbody>

    ...
    <header class="text-gray-600">
        <div class="container mx-auto flex justify-between items-center p-5 items-center">
            ...
            <div class="flex items-center">
                ...
                <button type=" button" onclick="window.location.href='{{ route('admin.product.store')}}'" class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base md:mt-0">Admin
